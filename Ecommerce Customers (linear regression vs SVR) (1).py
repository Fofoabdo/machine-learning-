...
# MSE for the linear regression model is 0.111 ,note :after using graid search \
# MSE for the SVR is 0.22\
# we can see that the linear regression model is good than SVC model\
# so lets try to minimize the error between our data in linear regression model by using 'grid search'\
